...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   ...
   <let name="featureIDs" value="'#linguistic', '#mod'"/>
   <let name="fsIDs" value="''"/>
   <pattern>
      <rule context="@feats">
         <let name="values"
              value="for $i in tokenize(current(), '\s+') return substring-after($i, '#') "/>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'all']">
         <assert test="tei:f[@name eq 'description']"> The feature “description” is
                            missing </assert>
         <assert test="tei:f[@name eq 'taxonomy']"> The feature “taxonomy” is
                            missing </assert>
      </rule>
      <rule context="tei:f[@name eq 'description'][parent::fs[@type eq 'all']]">
         <assert test="tei:string"> The element string is
                        required </assert>
         <report test="tei:string[not(*)]">This feature must contain a string element with content </report>
      </rule>
      <rule context="tei:f[@name eq 'taxonomy'][parent::fs[@type eq 'all']]">
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'linguistic']">
         <assert test="tei:f[@name eq 'category']"> The feature “category” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'phonetic']">
         <assert test="if (count(./tei:f) gt 2) then tei:f[@name = ('position')] else true()"> The mandatory features are 'process', 'constriction'; and the optional ones are
                            'position'. There is a feature in
                        this structure that has not been declared </assert>
         <assert test="tei:f[@name eq 'process']"> The feature “process” is
                            missing </assert>
         <assert test="tei:f[@name eq 'constriction']"> The feature “constriction” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'alteration']">
         <assert test="tei:f[@name eq 'mode']"> The feature “mode” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'assimilation']">
         <assert test="if (count(./tei:f) gt 0) then tei:f[@name = ('direction')] else true()"> The mandatory features are ''; and the optional ones are
                            'direction'. There is a feature in
                        this structure that has not been declared </assert>
      </rule>
      <rule context="tei:f[@name eq 'direction'][parent::fs[@type eq 'assimilation']]"/>
      <rule context="tei:fs[not(@feats)][@type eq 'morphosyntatic']">
         <assert test="tei:f[@name eq 'POS']"> The feature “POS” is
                            missing </assert>
         <assert test="tei:f[@name eq 'process']"> The feature “process” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'alternation']">
         <assert test="tei:f[@name eq 'lexeme']"> The feature “lexeme” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'VB']">
         <assert test="if (count(./tei:f) gt 1) then tei:f[@name = ('agreement')] else true()"> The mandatory features are 'stem-tense'; and the optional ones are
                            'agreement'. There is a feature in
                        this structure that has not been declared </assert>
         <assert test="tei:f[@name eq 'stem-tense']"> The feature “stem-tense” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'concord']">
         <assert test="tei:f[@name eq 'PERS']"> The feature “PERS” is
                            missing </assert>
         <assert test="tei:f[@name eq 'NUM']"> The feature “NUM” is
                            missing </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'PR']">
         <assert test="if (count(./tei:f) gt 0) then tei:f[@name = ('agreement', 'case')] else true()"> The mandatory features are ''; and the optional ones are
                            'agreement', 'case'. There is a feature in
                        this structure that has not been declared </assert>
      </rule>
      ...
      <rule context="tei:fs[not(@feats)][@type eq 'language-transfer']">
         <assert test="tei:f[@name eq 'language']"> The feature “language” is
                            missing </assert>
      </rule>
